...
def parse_arguments(parser):
    ...
    parser.add_argument('--L2', type=float, default=0.001, help='L2 regularization coefficient for all weights except Seq2Seq.ipynb (default value: 0.001)')
    parser.add_argument('--dropout_rate', type=float, default=0.5, help='Dropout rate used for the hidden layer of Seq2Seq.ipynb (default value: 0.5)')
